...
## 블루투스 키보드 단축키  
![Shortcut01](http://i.imgur.com/XEpYDPz.png)  
![Shortcut02](http://i.imgur.com/clwKitT.png)  
iOS 8, iOS 9 모두 지원됩니다.  
기본적으로 command + option + x 를 누르면 검색 결과가 닫힙니다.  
메인 화면에서는 기본 검색, 연속 검색을 실행하거나 마지막으로 사용했던 검색어를 불러올 수 있습니다.  
